...
1. Please make sure there is no [open issue](https://github.com/octokit/oauth-app.js/issues?utf8=%E2%9C%93&q=is%3Aissue) yet.
...
```shell
git clone https://github.com/<your account name>/oauth-app.js.git
cd oauth-app.js
npm install
```
...
- Submit a pull request from your topic branch to the master branch on the `octokit/oauth-app.js` repository.
- Be sure to tag any issues your pull request is taking care of / contributing to. Adding "Closes #123" to a pull request description will automatically close the issue once the pull request is merged in.

## Testing a pull request from github repo locally:

You can install `@octokit/oauth-app` from each pull request. Replace `[PULL REQUEST NUMBER]`:

```
npm install https://github.pika.dev/`octokit/oauth-app.js`/pr/[PULL REQUEST NUMBER]
```

Once you are done testing, you can revert back to the default module `@octokit/oauth-app` from npm with `npm install @octokit/oauth-app`
